...
Profile the devices
    ...
    # Profile the system for "bgp;config;interface;platform;ospf;arp;vrf;vlan" on devices "nx-osv-1;csr1000v-1" as "output/aliases/good_snapshots" using alias "helper"
